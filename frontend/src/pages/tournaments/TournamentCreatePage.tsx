...
export default function TournamentCreatePage() {
  ...
  const fieldClass = clsx(
    "w-full rounded-sm border px-4 py-2.5 text-sm placeholder:opacity-[0.22] focus:border-brand-500/50 focus:outline-none",
    t.border,
    t.metricBg,
    t.textPrimary,
  );
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              ...
              <div className="lg:col-span-2">
                ...
                <textarea
                  ...
                  disabled={isBusy}
                  placeholder="Tournoi local ouvert aux équipes de la région…"
                  rows={4}
