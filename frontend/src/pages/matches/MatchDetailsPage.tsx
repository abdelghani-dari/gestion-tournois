...
function ScoreComparisonCard({
  ...
  const homeWinner = hasScore && winnerId === match.home_team_id;
  const awayWinner = hasScore && winnerId === match.away_team_id;
...
export default function MatchDetailsPage() {
  ...
  const roundLabel = match?.round_number ? `Round ${match.round_number}` : "Round non renseigne";
    ...
    <>
      ...
      <div className="min-h-screen bg-[linear-gradient(180deg,#020617_0%,#030712_58%,#020617_100%)] font-sans text-slate-400">
        ...
        <main className="mx-auto max-w-7xl px-4 pb-20 pt-[5.5rem] sm:px-6">
          <Link
            to={match ? `/tournaments/${match.tournament_id}/bracket` : "/"}
          ...
          {!loading && !error && match && (
            <div className="space-y-6">
              <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div className="min-w-0">
                  ...
                  <p className="mt-2 text-sm text-slate-500">
                    {roundLabel} - {formatDateTime(match.match_date)}
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.55fr)_minmax(320px,0.9fr)]">
                <div className="space-y-6">
                  <ScoreComparisonCard match={match} home={home} away={away} winnerId={winnerId} hasScore={hasScore} />
                ...
                <aside className="space-y-6">
                  <Section title="Informations du match" description="Donnees principales du tableau.">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <InfoCard label="Round" value={match.round_number} />
                      <InfoCard label="Position" value={match.bracket_position} />
                      <InfoCard label="Bracket" value={statusLabel(match.bracket_status)} />
                      <InfoCard label="Match suivant" value={match.next_match_id ? `#${match.next_match_id} (${match.next_slot ?? "-"})` : "-"} />
                      <InfoCard label="Vainqueur ID" value={match.winner_team_id} />
              ...
              <Section
                title={isKnockout ? "Classement indicatif" : "Classement"}
